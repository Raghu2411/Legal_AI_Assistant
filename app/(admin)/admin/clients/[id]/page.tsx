...
import { FileText, ArrowLeft, Calendar, Briefcase, User, ShieldCheck } from "lucide-react"
import Link from "next/link"

export default async function AdminClientOverviewPage({ params }: { params: { id: string } }) {
    ...
    <div className="p-8 flex flex-col gap-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Admin Oversight: Client View</h1>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Admin quality control over all legal documents and evidence.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button size="lg" className="w-full" asChild>
            <Link href={`/admin/clients/${params.id}/vault`}>
